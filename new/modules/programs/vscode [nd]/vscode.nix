{
  # TODO: unify font settings in json files via font.nix
  flake.modules.homeManager.vscode = {...}: let
  ...
  in {
    ...
    home.file.".config/VSCodium/User/keybindings.json".text = keybindings;
  };
}
