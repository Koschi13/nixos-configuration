  ...
  wayland.windowManager.sway = {
    ...
    config = {
      ...
      in lib.mkOptionDefault {
        ...
        "${m}+Backspace" =
          "exec ${pkgs.swaylock-effects}/bin/swaylock --screenshots --clock --indicator --indicator-radius 100 --indicator-thickness 7 --effect-blur 7x5 --effect-vignette 0.5:0.5 --ring-color bb00cc --key-hl-color 880033 --line-color 00000000 --inside-color 00000088 --separator-color 00000000 --grace 2 --fade-in 0.2 --ignore-empty-password";
      ...
      floating = let m = config.wayland.windowManager.sway.config.modifier;
      in lib.mkOptionDefault {
        modifier = "${m} normal";
        criteria = [
          { title = "Emulator"; }
