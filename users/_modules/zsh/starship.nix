...
let
  ...
  paletteSet = builtins.fromTOML (builtins.readFile (
    # TODO: utilize flake and let it decide the hash
    builtins.fetchurl {
      url =
        "https://raw.githubusercontent.com/catppuccin/starship/main/palettes/frappe.toml";
      sha256 =
        "d040b8442d60eb99143269b1d777650c4e4495f1dfb9583f9a0ab8c730f44e5f";
    }));
in {
  programs.starship = let flavor = "frappe";
  in {
    ...
    settings = mergeAllAttrSets [
      ...
      disabledModules
      {
        ...
        sudo = { style = "bold Rosewater"; };
        nix_shell = { style = "Teal"; };
        character = {
